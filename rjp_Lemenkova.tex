...
Automated data processing and statistical models are widely used in geosciences \cite{Safari,Uwiduhaye2021a,Uwiduhaye2021b,Uwiduhaye2018,Lemenkov,Lemenkova2019c,Schenke2008,Banerjee}. These and other papers concern many research questions about effective data visualization and modeling, data comparison and correlation, while mapping and cartographic plotting remain to be addressed. Cartographic questions of this paper that contributes to the existing pool of GIS based research on Rwanda include, besides geophysical and seismic analysis, specific issues of scripting approach to data processing, using a variety of GMT modules and R functions for data visualization. These include, among others, for example, design of symbols and map layouts, location and placements of cartographic elements, presenting different thematic overlays to assess correlation between the seismic, geophysical and topographic setting in Rwanda, determining optimal color palettes that are more suitable for depicting continuous geophysical and topographic data and discrete scatterplot seismic data, analysis of the data reliability, actuality and quality. 
...
\bibitem{Suetova}I.A. Suetova, L.A. Ushakova, P. Lemenkova, Geoinformation mapping of the Barents and Pechora Seas. Geogr. Nat. Resour. \textbf{4}, 138--142 (2005). https://doi.org/10.6084/m9.figshare.7435535
...
\bibitem{Lemenkova2019c}P. Lemenkova, AWK and GNU Octave Programming Languages Integrated with Generic Mapping Tools for Geomorphological Analysis. GeoScience Engineering \textbf{65}(4), 1--22 (2019). https://doi.org/10.35180/gse-2019-0020 

\bibitem{Schenke2008}H. W. Schenke, P. Lemenkova, Zur Frage der Meeresboden-Kartographie: Die Nutzung von AutoTrace Digitizer für die Vektorisierung der Bathymetrischen Daten in der Petschora-See. Hydrographische Nachrichten \textbf{81}, 16--21 (2008). https://doi.org/10.6084/m9.figshare.7435538
